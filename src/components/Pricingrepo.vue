    ...
    <div class="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
      <div class="sm:flex sm:flex-col sm:align-center">
        ...
        <p class="mt-5 text-xl text-gray-500 sm:text-center">
          Improving Standards of Care through Veterinary Bundles
        </p>
      </div>
      <div
          ...
          <div class="p-6">
            ...
            <p class="mt-8">
              ...
              <span class="text-base font-medium text-gray-500">
                value when charged individually
              </span>
            </p>
            <p
              class="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-lg font-semibold text-white text-center hover:bg-gray-900"
            >
              ${{ bundle.cost }}
              <br />
              Bundle Price
    ...
    return {
      bundles: [
        ...
        },
        {
          ...
          value: 1500,
          description:
            "Would you like to feel sick for twice the time, or do you want to get well sooner? Admission for treatment of a known condition where further diagnostics are not indicated and treatment is supportive.",
          items: [
            "Packed Cell Volume (PCV)",
            "Total Proteins (TSP)",
            "Blood Gas Analysis",
